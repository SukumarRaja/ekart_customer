...
import 'package:ekart/view/screen/order/order_details_screen.dart';
    ...
    if (data) {
      ...
      _image = (message.data['image'] != null &&
          ...
          ? message.data['image'].startsWith('http')
              ? message.data['image']
              : '${AppConfig.BASE_URL}/storage/app/public/notification/${message.data['image']}'
          : null;
    } else {
      ...
      if (Platform.isAndroid) {
        _image = (message.notification.android.imageUrl != null &&
            ...
            ? message.notification.android.imageUrl.startsWith('http')
                ...
                : '${AppConfig.BASE_URL}/storage/app/public/notification/${message.notification.android.imageUrl}'
            : null;
        ...
        _image = (message.notification.apple.imageUrl != null &&
            ...
            ? message.notification.apple.imageUrl.startsWith('http')
                ...
                : '${AppConfig.BASE_URL}/storage/app/public/notification/${message.notification.apple.imageUrl}'
            : null;
      }
    }
